...
\begingroup
    ...
    \begin{tabular}{p{3.5cm} p{11.5cm}}
        \vspace{0mm} \includegraphics[width=3cm]{opening/resources/about/kleiner.png} & \vspace{-0.5mm} {\large \bf \thesisAuthor} 
        \hfill
    ...
    \noindent
    \begin{tabular}{p{3.5cm} p{11.5cm}}
        \vspace{0mm} \includegraphics[width=3cm]{opening/resources/about/coomer.png} & \vspace{-0.5mm} {\large \bf \thesisTutor} 
        \hfill
        \href{https://orcid.org/}{  % Link to your orcid
            \icon{\faOrcid}{10}{orcid-green}
        }
