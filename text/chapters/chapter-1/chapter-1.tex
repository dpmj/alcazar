...
Morbi porttitor dictum molestie. \glsname{conflictresource}, (\glsdesc{choke}), \glspl{cubesat} sed vitae iaculis libero. Suspendisse in gravida lacus, tempor ultrices nibh. Nam consequat scelerisque porttitor \cite{solder-defects}.
...
\lipsum[15]: \glsname{sfd} \glsdesc{mpcie} malesuada. 
